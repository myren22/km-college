...
public class  SimpleTest {
	...
	static double method2(double amount, double interestRate, int periods) 
		{
		double payment;
	...
	static double method3(double amount, double interestRate, double Payment) 
        {
	...
	static double method4(double interestRate, double Payment, int periods) 
 		{
		double amount;
	...
	static double method5(double interestRate, double finalAmount, int periods) 
		{
	...
	static double method6(double interestRate, double finalAmount, double Payment)
		{
		double numberOfPayments;
